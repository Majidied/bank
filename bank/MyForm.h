...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pn_login->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			this->pn_login->Name = L"pn_login";
			this->pn_login->Size = System::Drawing::Size(1518, 662);
			...
			this->pn_admin->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			this->pn_admin->Name = L"pn_admin";
			this->pn_admin->Size = System::Drawing::Size(1518, 662);
			...
			this->pn_client->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			this->pn_client->Name = L"pn_client";
			this->pn_client->Size = System::Drawing::Size(1518, 662);
			...
			this->principal_panel->Margin = System::Windows::Forms::Padding(5, 5, 5, 5);
			this->principal_panel->Name = L"principal_panel";
			this->principal_panel->Size = System::Drawing::Size(1518, 662);
			this->principal_panel->TabIndex = 3;
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(516, 199);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(316, 184);
			...
			this->ClientSize = System::Drawing::Size(1518, 662);
